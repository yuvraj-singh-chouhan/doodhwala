function DeliveryProcess() {
    ...
    return (
        <section className="relative w-full overflow-hidden pb-16 pt-24 bg-white z-0">
            {/* Header Content */}
            <div className="container mx-auto px-6 md:px-12 lg:px-[120px] relative z-20">
                <div className="text-center mb-10">
                    <h1 className="font-[Ruksha] text-[40px] md:text-[55px] lg:text-[65px] text-[#45628A] uppercase leading-none mb-3 tracking-wide">
            ...
            <div className="hidden lg:flex relative w-full max-w-[1100px] mx-auto h-[600px] items-center justify-center mt-6 mb-12 z-10">
                ...
                <div className="absolute w-[470px] h-[470px] rounded-full border-[1.5px] border-dashed border-[#A5B4C3] flex items-center justify-center pointer-events-none -z-10" />
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% - 180px), calc(-50% - 151px))" }}>
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 right-[100%] mr-[45px] w-max max-w-[280px] text-right">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[0].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[0].subTitle}</p>
                    </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% - 235px), calc(-50% - 0px))" }}>
                    <img src={DeliveryProcessInfo[3].img} className="w-[85px] h-[85px] object-contain" alt={DeliveryProcessInfo[3].title} />
                    <div className="absolute top-1/2 -translate-y-1/2 right-[100%] mr-[45px] w-max max-w-[280px] text-right">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[1].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[1].subTitle}</p>
                    </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% - 180px), calc(-50% + 151px))" }}>
                    <img src={DeliveryProcessInfo[3].img} className="w-[85px] h-[85px] object-contain" alt={DeliveryProcessInfo[3].title} />
                    <div className="absolute top-1/2 -translate-y-1/2 right-[100%] mr-[45px] w-max max-w-[280px] text-right">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[2].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[2].subTitle}</p>
                    </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% + 180px), calc(-50% - 151px))" }}>
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 left-[100%] ml-[45px] w-max max-w-[280px] text-left">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[3].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[3].subTitle}</p>
                    </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% + 235px), calc(-50% + 0px))" }}>
                    <img src={DeliveryProcessInfo[3].img} className="w-[85px] h-[85px] object-contain" alt={DeliveryProcessInfo[3].title} />
                    <div className="absolute top-1/2 -translate-y-1/2 left-[100%] ml-[45px] w-max max-w-[280px] text-left">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[4].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[4].subTitle}</p>
                    </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 z-20 transition-transform hover:scale-105" style={{ transform: "translate(calc(-50% + 180px), calc(-50% + 151px))" }}>
                    <img src={DeliveryProcessInfo[3].img} className="w-[85px] h-[85px] object-contain" alt={DeliveryProcessInfo[3].title} />
                    <div className="absolute top-1/2 -translate-y-1/2 left-[100%] ml-[45px] w-max max-w-[280px] text-left">
                        <p className="font-poppins text-[21px] font-bold text-[#45628A] mb-[2px]">{DeliveryProcessInfo[5].title}</p>
                        <p className="font-poppins text-[14px] text-[#7A848D]">{DeliveryProcessInfo[5].subTitle}</p>
                    </div>
                </div>
            ...
            <div className="flex lg:hidden flex-col gap-6 w-full px-6 mt-12 mb-6 z-10 max-w-[450px] mx-auto">
                {DeliveryProcessInfo.map((item, idx) => (
                    <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-[0_2px_10px_-2px_rgba(0,0,0,0.1)] border border-gray-50" key={idx}>
                        <div className="w-[60px] h-[60px] rounded-full flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                            <img src={`/DP/DP${idx + 1}.png`} className="w-[80%] h-[80%] object-contain drop-shadow-sm" alt={item.title} />
                        </div>
                        <div>
            ...
            <div className="w-full flex justify-center mt-14 mb-8 relative z-20">
                <button className="bg-[#59789E] hover:bg-[#45628A] text-white font-poppins px-8 py-[20px] font-semibold text-lg rounded-full shadow-md transition-all">
