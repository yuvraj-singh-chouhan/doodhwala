    ...
    return (
        <header className="sticky top-0 left-0 w-full z-[100] bg-white shadow-sm transition-all duration-300">
            <nav className="container mx-auto px-6 md:px-24 py-4 font-poppins flex items-center justify-between relative">
                ...
                <button className="hidden md:flex items-center gap-2 md:px-5 px-3 py-3 border-[1.5px] border-brand-dark-blue rounded-full font-bold text-lg hover:bg-[#5774a0] hover:text-white transition-all">
                    <FaWhatsapp className="text-lg" />
                    <span className="">Message on WhatsApp</span>
                </button>

                {/* Mobile WhatsApp Button */}
                <button className="md:hidden flex items-center justify-center w-[55px] h-[55px] rounded-full border border-gray-400 text-gray-700 hover:bg-gray-100 transition-colors flex-shrink-0">
                ...
                <div className={`fixed top-0 left-0 w-[80%] max-w-[300px] h-full bg-white z-50 shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    <div className="mt-auto p-6 border-t border-gray-100">
                        <button className="w-full flex justify-center items-center gap-2 py-3.5 bg-[#5A779D] text-white rounded-full font-bold text-[17px] hover:bg-[#45628A] transition-all shadow-md">
