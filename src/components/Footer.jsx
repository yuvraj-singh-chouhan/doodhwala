...
function Footer() {
    return (
        <footer className="bg-[#D8E4F6] font-['Poppins',sans-serif] pt-12 relative w-full overflow-hidden">
            {/* Main Content */}
            <div className="container mx-auto px-6 md:px-12 lg:px-[120px] relative z-10 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-6 lg:col-span-5 flex flex-col items-start text-[14px]">
                        ...
                        <p className="text-gray-700 mb-8 leading-relaxed max-w-[400px]">
                    ...
                    <div className="md:col-span-3 lg:col-span-2 flex flex-col mt-4 md:mt-2">
                        ...
                        <ul className="space-y-3">
                            <li><a href="#" className="text-sm text-gray-700 hover:text-gray-900 transition-colors font-medium">Why Choose Us</a></li>
                            <li><a href="#" className="text-sm text-gray-700 hover:text-gray-900 transition-colors font-medium">Our Process</a></li>
                            <li><a href="#" className="text-sm text-gray-700 hover:text-gray-900 transition-colors font-medium">Subscription</a></li>
                            <li><a href="#" className="text-sm text-gray-700 hover:text-gray-900 transition-colors font-medium">Contact</a></li>
                        </ul>
                    </div>
            ...
            {/* Overlapping Bottles */}
            <div className="absolute bottom-0 right-0 md:right-[5%] lg:right-[8%] w-[250px] md:w-[350px] lg:w-[450px] z-20 pointer-events-none origin-bottom hidden md:flex justify-end">
